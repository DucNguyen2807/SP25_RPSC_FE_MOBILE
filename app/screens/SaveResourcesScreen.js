...
// ========== SAVING ELECTRICITY AND WATER PAGE ==========
export const SaveResourcesScreen = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerTitle}>Tiết kiệm điện nước</Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroContainer}>
          <Image 
            source={{ uri: 'https://via.placeholder.com/400/E3F2FD/2196F3?text=Save+Resources' }}
            style={styles.heroImage}
            resizeMode="cover"
          />
          <View style={styles.heroOverlay}>
            <View style={[styles.iconCircle, { backgroundColor: '#E3F2FD' }]}>
              <Ionicons name="water-outline" size={36} color="#2196F3" />
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Tại sao nên tiết kiệm?</Text>
          <Text style={styles.paragraph}>
            Tiết kiệm điện nước không chỉ giúp bạn giảm chi phí sinh hoạt hàng tháng mà còn góp phần 
            bảo vệ môi trường. Với một số thói quen đơn giản, bạn có thể tiết kiệm đáng kể lượng tài nguyên sử dụng.
          </Text>
        </View>

        {/* Tips List */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Mẹo tiết kiệm điện</Text>
          
          <View style={styles.tipItem}>
            <View style={[styles.tipIconSmall, { backgroundColor: '#E3F2FD' }]}>
              <Ionicons name="bulb-outline" size={20} color="#2196F3" />
            </View>
            <View style={styles.tipContent}>
              <Text style={styles.tipItemTitle}>Sử dụng đèn LED</Text>
              <Text style={styles.tipDescription}>
                Đèn LED tiêu thụ ít điện hơn 80% so với đèn sợi đốt truyền thống và có tuổi thọ dài hơn.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tipItem}>
            <View style={[styles.tipIconSmall, { backgroundColor: '#E3F2FD' }]}>
              <Ionicons name="thermometer-outline" size={20} color="#2196F3" />
            </View>
            <View style={styles.tipContent}>
              <Text style={styles.tipItemTitle}>Điều chỉnh nhiệt độ máy lạnh</Text>
              <Text style={styles.tipDescription}>
                Đặt máy lạnh ở 25-26°C, đủ mát và tiết kiệm điện. Mỗi độ tăng giúp tiết kiệm 3-5% điện năng.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tipItem}>
            <View style={[styles.tipIconSmall, { backgroundColor: '#E3F2FD' }]}>
              <Ionicons name="power-outline" size={20} color="#2196F3" />
            </View>
            <View style={styles.tipContent}>
              <Text style={styles.tipItemTitle}>Rút phích cắm thiết bị</Text>
              <Text style={styles.tipDescription}>
                Nhiều thiết bị tiếp tục tiêu thụ điện ở chế độ chờ. Rút phích cắm khi không sử dụng.
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Mẹo tiết kiệm nước</Text>
          ...
          <View style={styles.tipItem}>
            ...
            <View style={styles.tipContent}>
              <Text style={styles.tipItemTitle}>Sửa rò rỉ nhanh chóng</Text>
              <Text style={styles.tipDescription}>
                Một vòi nước nhỏ giọt có thể lãng phí hơn 11.000 lít nước mỗi năm.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tipItem}>
            ...
            <View style={styles.tipContent}>
              <Text style={styles.tipItemTitle}>Rút ngắn thời gian tắm</Text>
              <Text style={styles.tipDescription}>
                Giảm thời gian tắm xuống 5 phút có thể tiết kiệm đến 4.000 lít nước mỗi tháng.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tipItem}>
            <View style={[styles.tipIconSmall, { backgroundColor: '#E3F2FD' }]}>
              <Ionicons name="wine-outline" size={20} color="#2196F3" />
            </View>
            <View style={styles.tipContent}>
              <Text style={styles.tipItemTitle}>Tái sử dụng nước</Text>
              <Text style={styles.tipDescription}>
                Nước từ máy giặt, rửa rau có thể được dùng lại để tưới cây, lau sàn.
              </Text>
            </View>
          </View>
        </View>
        ...
        {/* Tracking Section */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Theo dõi tiêu thụ</Text>
          <View style={styles.trackingCard}>
            <Text style={styles.trackingCardText}>
              Ghi nhận lượng điện nước sử dụng hàng tháng để biết được hiệu quả của việc tiết kiệm. 
              Bạn có thể sử dụng các ứng dụng trên điện thoại để theo dõi chi tiêu.
            </Text>
            <TouchableOpacity style={styles.trackingButton}>
              <Text style={styles.trackingButtonText}>Theo dõi ngay</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
...
// ========== LIVING TOGETHER HARMONIOUSLY PAGE ==========
...
export default SaveResourcesScreen;